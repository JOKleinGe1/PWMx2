...
test.asm : test.hex
	$(OBJDUMP) $^  -d > $@
tb_sys_picorv32.vvp  :  picorv32.v  system_picorv32.v  tb_sys_picorv32.v test.mem32 ram1port8k_sim.v BCDto7seg.v pwm_x2.v
	iverilog  -o $@  picorv32.v  system_picorv32.v  tb_sys_picorv32.v  ram1port8k_sim.v BCDto7seg.v pwm_x2.v
